...
abstract class $BottomNavModelCopyWith<$Res> {
  factory $BottomNavModelCopyWith(
    BottomNavModel value,
    $Res Function(BottomNavModel) then,
...
abstract class _$$BottomNavModelImplCopyWith<$Res>
    implements $BottomNavModelCopyWith<$Res> {
  factory _$$BottomNavModelImplCopyWith(
    _$BottomNavModelImpl value,
...
class __$$BottomNavModelImplCopyWithImpl<$Res>
  ...
  __$$BottomNavModelImplCopyWithImpl(
    _$BottomNavModelImpl _value,
    $Res Function(_$BottomNavModelImpl) _then,
  ) : super(_value, _then);
...
class _$BottomNavModelImpl implements _BottomNavModel {
  const _$BottomNavModelImpl({required this.id, required this.name});
  ...
  @override
  String toString() {
    return 'BottomNavModel(id: $id, name: $name)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$BottomNavModelImplToJson(this);
  }
}

abstract class _BottomNavModel implements BottomNavModel {
  const factory _BottomNavModel({
